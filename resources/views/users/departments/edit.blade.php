...
@section('title','User - Department Edit')
              ...
              <div class="card-body">
                <form action="{{ route('user.departments.update', $department->id) }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" name="department_name" class="form-control" id="inputName" placeholder="Enter Department Name" value="{{ old('department_name', $department->department_name) }}">
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <textarea name="department_details" class="form-control" id="inputDetails" placeholder="Enter Department Details">{{ old('department_name', $department->department_details) }}</textarea>
                    </div>
